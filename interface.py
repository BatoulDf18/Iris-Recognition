...
ASSETS_PATH = OUTPUT_PATH / Path(r"./pictures_interface")
...
def resultat(y, matching_res):
    ...
    image_66 = canvas.create_image(487.0, 576.0, image=image_image_66)
        ...
        # Load images
    img1 = Image.open("./results/real.png")
    img2 = Image.open("./results/processed.png")
...
if __name__ == "__main__":
    # Créer un thread pour l'extraction et le démarrer
    extraction_thread = threading.Thread(target=extractions)
    extraction_thread.start()

    # Continuer avec la création de la fenêtre principale
    create_main_window()
